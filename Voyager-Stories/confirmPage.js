	...
	function confirm(){
		window.location.replace("http://localhost/CSR_Project/Voyager-Stories/thankyouPage.html");
		//window.location.replace("http://localhost/HotelBooking/thankyouPage.html");
	}